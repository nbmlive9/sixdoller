...
@Component({
  selector: 'app-search-userdata-employee',
  templateUrl: './search-userdata-employee.component.html',
  styleUrls: ['./search-userdata-employee.component.scss']
})
export class SearchUserdataEmployeeComponent {
