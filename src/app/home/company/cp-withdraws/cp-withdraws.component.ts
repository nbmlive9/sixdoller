...
@Component({
  selector: 'app-cp-withdraws',
  templateUrl: './cp-withdraws.component.html',
  styleUrls: ['./cp-withdraws.component.scss']
})
export class CpWithdrawsComponent {
  ...
  ngOnInit() {
    this.api.WithdrawReportAdmin().subscribe((res: any) => {
      this.data1 = res.data || [];
